...
ms.locfileid: "906313"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="932c1-103">生命週期資料匯出</span><span class="sxs-lookup"><span data-stu-id="932c1-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="932c1-104">此頁面正在開發中。</span><span class="sxs-lookup"><span data-stu-id="932c1-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="932c1-105">匯出所有產品</span><span class="sxs-lookup"><span data-stu-id="932c1-105">Export all products</span></span>
<span data-ttu-id="932c1-106">按一下下列專案，以匯出所有產品的生命週期資料：</span><span class="sxs-lookup"><span data-stu-id="932c1-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="932c1-107">匯出所有產品</span><span class="sxs-lookup"><span data-stu-id="932c1-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="932c1-108">依系列和群組匯出產品</span><span class="sxs-lookup"><span data-stu-id="932c1-108">Export products by Family and Group</span></span>
<span data-ttu-id="932c1-109">選取系列，然後選取要匯出的群組。</span><span class="sxs-lookup"><span data-stu-id="932c1-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="932c1-110">附注：選取 [群組值時，就會開始匯出]。</span><span class="sxs-lookup"><span data-stu-id="932c1-110">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="932c1-171">在支援日期之後匯出產品</span><span class="sxs-lookup"><span data-stu-id="932c1-171">Export products by end of support date</span></span>
<span data-ttu-id="932c1-172">選取 [一年]，以查看產品是否到達支援終止。</span><span class="sxs-lookup"><span data-stu-id="932c1-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="932c1-173">附注：選取 [年份] 值時，就會開始匯出。</span><span class="sxs-lookup"><span data-stu-id="932c1-173">Note: Export will begin when Year value is selected.</span></span>

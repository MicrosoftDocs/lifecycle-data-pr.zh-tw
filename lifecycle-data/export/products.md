...
ms.locfileid: "899793"
---
# <a name="export"></a><span data-ttu-id="ae4eb-103">匯出</span><span class="sxs-lookup"><span data-stu-id="ae4eb-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="ae4eb-104">此頁面正在開發中。</span><span class="sxs-lookup"><span data-stu-id="ae4eb-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="ae4eb-105">匯出所有產品</span><span class="sxs-lookup"><span data-stu-id="ae4eb-105">Export All Products</span></span>
<span data-ttu-id="ae4eb-106">匯出所有不含任何篩選器的產品。</span><span class="sxs-lookup"><span data-stu-id="ae4eb-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="ae4eb-107">匯出所有產品</span><span class="sxs-lookup"><span data-stu-id="ae4eb-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="ae4eb-108">依類別匯出產品</span><span class="sxs-lookup"><span data-stu-id="ae4eb-108">Export Products by Category</span></span>
<span data-ttu-id="ae4eb-109">選取要匯出的群組：</span><span class="sxs-lookup"><span data-stu-id="ae4eb-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="ae4eb-167">支援年結束時匯出產品</span><span class="sxs-lookup"><span data-stu-id="ae4eb-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="ae4eb-168">選取一年來匯出產品終止服務的年：</span><span class="sxs-lookup"><span data-stu-id="ae4eb-168">Select a year to export products ending service in that year:</span></span>
